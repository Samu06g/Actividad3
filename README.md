...
- Puedes ver el código fuente de esta apliación [aquí](https://github.com/Samu06g/Actividad3/tree/main/ConversorTemperaturas/src/main/java/git/conversortemperaturas/ConversorTemperaturas.java ).
#### 4. _Tip Calculator_
Sin modificaciones.
